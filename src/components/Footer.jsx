...
const Footer = () => {
  ...
  return (
    <footer class="bg-white dark:bg-gray-900 font-work">
      <div class="container px-6 py-12 mx-auto">
          <div class="grid grid-cols-1 gap-6 tablet:grid-cols-2 tablet:gap-y-10 desktop:grid-cols-4">
              <div class="tablet:col-span-2">
                  <h1 class="max-w-desktop text-desktop font-semibold tracking-tight text-gray-800 desktop:text-2desktop dark:text-white">Subscribe our newsletter to get update.</h1>

                  <div class="flex flex-col mx-auto mt-6 space-y-3 tablet:space-y-0 tablet:flex-row">
                      <input id="email" type="text" class="px-4 py-2 text-gray-700 bg-white border rounded-tablet dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Email Address"/>
              
                      <button class="w-full px-6 py-2.5 text-tablet font-medium tracking-wider text-white transition-colors duration-300 transform tablet:w-auto tablet:mx-4 focus:outline-none bg-gray-800 rounded-desktop hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                          Subscribe
                      </button>
                  </div>
              </div>
          ...
          <hr class="my-6 border-gray-200 tablet:my-8 dark:border-gray-700"/>
