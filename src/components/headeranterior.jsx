                ...
                <div className={`z-30 w-full h-[70px] px-4 flex items-center ${scrollDown ? 'fixed bg-white  border border-b-2' : 'bg-transparent'} tablet:h-[90px]`}> 
                    ...
                    <div className='w-full h-full mx-auto max-w-screen-desktop flex justify-between items-center'>
                        ...
                        {scrollDown 
                            ? 
                            <>
                                <a href='#' className='flex justify-center items-center text-black'>
                                    <img onClick={openMenu} className='w-8 desktop:w-10' src={imgMenu} alt="menuIcon"/>
                            ...
                            <>
                                <a href='#'  className='flex justify-center items-center text-white'>
                                    <img onClick={openMenu} className='w-8 desktop:w-10' src={imgMenuWhite} alt="menuIcon"/>
